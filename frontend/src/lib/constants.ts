...
export const RPC_URL =
  isLocalBrowser ? "http://127.0.0.1:8899" : viteEnv.VITE_RPC_URL || "http://localhost:8899";
...
export const ACTIVITY_POLL_MS = IS_LOCAL_RPC ? 20_000 : 300_000;
export const ACTIVITY_LIMIT = IS_LOCAL_RPC ? 120 : 20;
export const ACTIVITY_SIGNATURES_PER_MARKET = IS_LOCAL_RPC ? 8 : 3;
export const PORTFOLIO_SIGNATURE_LIMIT = IS_LOCAL_RPC ? 120 : 20;
export const TRADE_PRICE_POLL_MS = IS_LOCAL_RPC ? 15_000 : 60_000;
export const TRADE_BOOK_POLL_MS = IS_LOCAL_RPC ? 10_000 : 60_000;
