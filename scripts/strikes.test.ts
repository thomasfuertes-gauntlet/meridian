...
describe("calculateStrikes", () => {
  it("META at $680 produces 7 strikes including rounded close", () => {
    const strikes = calculateStrikes(680);
    // 680 * 0.91 = 618.8 -> 620
    // 680 * 0.94 = 639.2 -> 640
    // 680 * 0.97 = 659.6 -> 660
    // 680 * 1.00 = 680.0 -> 680  (rounded close)
    // 680 * 1.03 = 700.4 -> 700
    // 680 * 1.06 = 720.8 -> 720
    // 680 * 1.09 = 741.2 -> 740
    assert.deepStrictEqual(strikes, [620, 640, 660, 680, 700, 720, 740]);
  });

  it("AAPL at $230 dedups collisions - rounded close merges with offset", () => {
    const strikes = calculateStrikes(230);
    // 230 * 0.91 = 209.3 -> 210
    // 230 * 0.94 = 216.2 -> 220
    // 230 * 0.97 = 223.1 -> 220  (dedup)
    // 230 * 1.00 = 230.0 -> 230  (rounded close)
    // 230 * 1.03 = 236.9 -> 240
    // 230 * 1.06 = 243.8 -> 240  (dedup)
    // 230 * 1.09 = 250.7 -> 250
    assert.deepStrictEqual(strikes, [210, 220, 230, 240, 250]);
  });
  ...
  it("handles round numbers cleanly", () => {
    ...
    // 1000 * 0.94 = 940
    // 1000 * 0.97 = 970
    // 1000 * 1.00 = 1000  (rounded close)
    // 1000 * 1.03 = 1030
    // 1000 * 1.06 = 1060
    // 1000 * 1.09 = 1090
    assert.deepStrictEqual(strikes, [910, 940, 970, 1000, 1030, 1060, 1090]);
  });
